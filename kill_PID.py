# delete PID from Port on RPI
# to start on Rpi -> sudo python kill_PID.py 5000
...
parser.add_argument("portnumber", help="The number of the port you want to kill (Eg. 5000)",
